export default function Description() {
    return (
      <>
        <div id="section-2" className="bg-gray-900 text-center pt-10 pb-20 break-words">        
          
          <h1 className="text-4xl text-teal-500 pb-10 mr-1 ml-1">
            <b>Join The Devs' Guild!</b>
          </h1>     
          
          <div id="description" className="txt-marg text-base">     
                <div id="statement" className="flex-col justify-center flex text-2xl">
                    <div className="pb-6">
                    The Devs' Guild is a community of about <strong className="font-bold">1000</strong> very active student and professional developers. 
                    </div>
