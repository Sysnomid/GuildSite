    ...
    return (
        <>
            <div className="bg-blue-900 text-teal-500 p-6 ml-6 mb-6 mr-6 rounded-2xl">
                <img className="h-40 w-40 rounded-full  mx-auto" src={props.ImgLink}/>
...
export default function Contact(){
    return (
        <>
            ...
            <div id="ContactUs" className="txt-marg text-base mt-5 text-center break-words">
                
                <h1 id="ContactHeader" className="text-5xl">
                    <b>Contact Us</b>
                </h1>
                    
                <br />
        
                <div id="Email" className="break-words pb-10">
